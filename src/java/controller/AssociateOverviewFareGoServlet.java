 ...
 * @author junyeol
 */
@WebServlet(name = "AssociateOverviewFareGoServlet", urlPatterns = {"/AssociateOverviewFareGoServlet"})
public class AssociateOverviewFareGoServlet extends HttpServlet {
    ...
    public void doPost (HttpServletRequest request, HttpServletResponse response) {
        ...
        try{
           ...
           ArrayList<Benefaction> benefaction = DBConnect.getBenefactionRecordsFareGo();
           ...
           System.out.println("home");
            request.getSession().setAttribute("selectedBenefaction", selected);
                    ...
                    String url = "/TWC2-CaseManagementSystem/AssociateListFareGo.jsp";
