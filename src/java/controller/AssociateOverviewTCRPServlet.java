 ...
 * @author junyeol
 */
@WebServlet(name = "AssociateOverviewTCRPServlet", urlPatterns = {"/AssociateOverviewTCRPServlet"})
public class AssociateOverviewTCRPServlet extends HttpServlet {
    ...
    public void doPost (HttpServletRequest request, HttpServletResponse response) {
        ...
        try{
           ...
           ArrayList<Benefaction> benefaction = DBConnect.getBenefactionRecordsMealcard();
           ...
           System.out.println("home");
            request.getSession().setAttribute("selectedBenefaction", selected);
                    ...
                    String url = "/TWC2-CaseManagementSystem/AssociateListTCRP.jsp";
