<%-- 
    Document   : AssociateListFareGo
    Created on : Aug 1, 2014, 3:37:42 PM
        ...
        <script src="/TWC2-CaseManagementSystem/jquery/jquery-validate-1.12.0.js"></script>
          ...
          <script>
            function onCancel(){
             ...
             function onSubmit(){
              document.form1.action="/TWC2-CaseManagementSystem/AssociateViewFareGo.jsp";
            }
             function onLogout(){
            ...
            <tr>
                <td class="containerE" valign="top" style="height:10%">
                    <div class="maincontent-associate">
                        <strong>List FareGo issued</strong>
