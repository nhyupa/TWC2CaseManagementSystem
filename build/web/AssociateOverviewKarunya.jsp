<%-- 
    Document   : OverviewKarunya
    Created on : Jun 14, 2014, 12:45:28 AM
         ...
         <!--javascript-->
           <script>
            function onCancel(){
             ...
             function onSubmit(){
                document.form1.action="/TWC2-CaseManagementSystem/AssociateOverviewKarunyaServlet";
            }
             function onLogout(){
        ...
        <table border ="2" class ="leftDivision">
            ...
            <tr>
                <td class="containerD"style="height:10%">
                    <div class="headertitle-associate">KARUNYA OVERVIEW</div>
            ...
            <tr>
                <td class="containerF" style="height:10%">
                   ...
                   <div class="btn-associate-landscape btn-associate">
                        <button type="Submit" class="btn btn-primary btn-large" style="width:155px;"onClick="onSubmit()">LIST<br>records</button>
                   </form>
                        &nbsp;&nbsp:
