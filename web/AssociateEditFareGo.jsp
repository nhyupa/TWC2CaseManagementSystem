<%-- 
    Document   : AssociateEditFareGo
    Created on : Aug 1, 2014, 4:25:49 PM
    ...
    <head>
        ...
        <script src="/TWC2-CaseManagementSystem/jquery/jquery-validate-1.12.0.js"></script>
         ...
         <script>
          ...
          <script>
             function onCancel(){
                 document.location.href="AssociateOverviewFareGo.jsp";
             }
             ...
             function onLogout(){
               ...
               function onSubmit(){
                 document.form1.action="/TWC2-CaseManagementSystem/AssociateEditFareGoServlet";
             }
        </script>
        <!--database-->
        <%
            ...
            <tr>
                <td class="containerE" valign="top" style="height:10%">
                    <div class="maincontent-associate">
                         <strong>Benefaction (FareGo)</strong>
                        <br><br>
                        <form id="editfaregoform" name="form1" method="post">
                        ...
                        <div class="form-group-associate">
                           ...
                           <div class="form-group-associate">
                            ...
                            <input type="text" class="form-control-associate" style="background-color:yellow;" name="value" value="<%=bene1.getBeneValue()%>" >
                        </div>
                           <div class="form-group-associate">
                            Remarks, conditions or time frame attached to benefit (500)
                            <textarea rows="5" class="form-control-associate" style="background-color:yellow;" name="remarks" maxlength="500" value="<%=bene1.getBeneRem()%>"></textarea>
                        </div>
                ...
                <td class="containerF" style="height:10%">
                 <br><br>
                    <div class="btn-associate-landscape btn-associate">
                        <button type="Submit" class="btn btn-primary btn-large" onClick="onSubmit()">SAVE &<br/>Go back to FareGo Overview</button>
                         </form>
                    &nbsp;&nbsp;
