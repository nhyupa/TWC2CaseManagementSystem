...
<html>
    <head>
        ...
        <script>
            ...
            function onSubmit() {
                document.garnishForm.action ="/TWC2-CaseManagementSystem/GarnishServlet";
            }
                ...
                <tr>
                    ...
                    <td rowspan="4" class="container6" valign="top" > <%--container6 --%>
                        <form id="garnishForm" name="garnishForm" role="form"  action ="#" method="post"> 
                            ...
                            <div style="font-family: arial;font-size:13px; font-weight:bold; margin-top:10px;margin-left:10px;">Complement: Phone</div>
                            <div class="col-md-10">
                                <label style="margin:0px;">
                                    Worker's Singapore phone number (12)
                                </label>
                                <input type="text" class="form-control" style="height:25px;" name="singaporePhoneNumber">
                            </div>
                            <div style="height:15px"> </div>
                            <div style="font-family: arial;font-size:13px; font-weight:bold; margin-top:30px;margin-left:10px;">Complement: Pass details</div>

                            <div class="col-md-10">
                                <label style="margin:0px;">
                                    <span class="asterick">*</span>Pass type
                                </label>
                                 <div style="width:60%"> </div>
                                <select style="height:25px;width:40%;font-size:10px;" class="form-control col-md-2" name="passType">
                                    <!-- get list of pass as select list  --> 
                            ...
                            <div class="col-md-10">
                                ...
                                <input style="height:25px;" type="text" class="form-control"name="otherPassType">
                            </div>

                            <div class="col-md-10">
                                <label style="margin:0px;">
                                    <span class="asterick">*</span> Pass number (20)
                                </label>
                                <input style="height:25px;" type="text" class="form-control"name="passNumber">
                            </div>

                            <div class="col-md-10">
                               <label style="margin:0px;">
                                    Pass application date
                                </label>
                                <input style="height:25px;width:50%;" type="date" class="form-control"name="passApplicationDate">
                            </div>
                            ...
                            <div class="col-md-10">
                                ...
                                <input style="height:25px;width:50%;" type="date" class="form-control"name="passIssueDate">
                            </div>
