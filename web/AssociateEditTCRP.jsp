<%-- 
    Document   : AssociateEditTCRP
    Created on : Aug 1, 2014, 3:02:35 PM
    ...
    <head>
        ...
        <script src="/TWC2-CaseManagementSystem/jquery/jquery-validate-1.12.0.js"></script>
         ...
         <script>
          ...
          <script>
             function onCancel(){
                document.location.href="AssociateOverviewTCRP.jsp";
             }
             function onSubmit(){
                 document.form1.action="/TWC2-CaseManagementSystem/AssociateEditTCRPServlet";
      ...
      <%
          ...
          Benefaction bene1=DBConnect.getBenefactionRecordsMealcard2(id2);
          String FIN=bene1.getFIN();
          String workerName = DBConnect.getWorkername(FIN);
      %>

        <title>Edit TCRP</title>
    </head>
    <body>
        <%-- left side menus--%>
            ...
            <tr>
                <td class="containerE" valign="top" style="height:10%">
                    <div class="maincontent-associate">
                        ...
                        <br><br>
                        <form id="edittcrpform" name="form1" method="post">
                        ...
                        <div class="form-group-associate">
                             ...
                             <option value="mealcard" >Meal Card</option>
                             <option value="mealcardr" >Meal Card R</option>
                             <option value="cashmeal" >Cash meal</option>
                          </select>
                        </div>
                        <div class="form-group-associate">
                            Serial number (30)
                            <input type="text" class="form-control-associate" style="background-color:yellow;" name="SerialNumber" value="<%=bene1.getBeneSerial()%>" maxlength="30">
                        </div>
                ...
                <td class="containerF" style="height:10%">
                 <br><br>
                    <div class="btn-associate-landscape btn-associate">
                        <button type="Submit" class="btn btn-primary btn-large" onClick="onSubmit()">SAVE &<br/>Go back to TCRP Overview</button>
                         </form>
                    &nbsp;&nbsp;
