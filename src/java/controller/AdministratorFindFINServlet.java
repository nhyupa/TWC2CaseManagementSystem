 ...
 * @author nhyupa.2010
 */
@WebServlet(name = "AdministratorFindFINServlet", urlPatterns = {"/AdministratorFindFINServlet"})
public class AdministratorFindFINServlet extends HttpServlet {
    ...
    public void doPost (HttpServletRequest request, HttpServletResponse response) {
        try{
            ...
            DBConnect.connectDB();
            String url = "/TWC2-CaseManagementSystem/AdminHomePage.jsp";
