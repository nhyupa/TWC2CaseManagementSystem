<%-- 
    Document   : AssociateViewKarunya
    Created on : Aug 1, 2014, 4:02:41 PM
    ...
    <head>
        ...
        <script src="/TWC2-CaseManagementSystem/jquery/jquery-validate-1.12.0.js"></script>
          ...
          <script>
             ...
             function onSubmit(){
                  document.location.href="/TWC2-CaseManagementSystem/AssociateEditKarunya.jsp";
             }
                    ...
                    <div class="maincontent-associate">
                          <%
                                ...
                                DBConnect.connectDB();
                                        ...
                                        Benefaction bene3 =DBConnect.getBenefactionRecordsKarunya2(id1);
                        ...
                        <div class="form-group-associate">
                            Date benefit given
                            <div class="form-control-associate"><%=benefitDate%></div>
                        </div>
                        <div class="form-group-associate">
                            Name of worker
