<%-- 
    Document   : AssociateListKarunya
    Created on : Aug 1, 2014, 3:43:14 PM
        ...
        <script src="/TWC2-CaseManagementSystem/jquery/jquery-validate-1.12.0.js"></script>
          ...
          <script>
            function onCancel(){
             ...
             function onSubmit(){
               document.form1.action="/TWC2-CaseManagementSystem/AssociateViewKarunya.jsp";
            }
             function onLogout(){
            ...
            <tr>
                <td class="containerE" valign="top" style="height:10%">
                    <div class="maincontent-associate">
                        <strong>List Karunya referrals</strong>
