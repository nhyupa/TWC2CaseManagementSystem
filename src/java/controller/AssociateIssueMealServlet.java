 ...
 * @author lee
 */
@WebServlet(name = "AssociateIssueMealServlet", urlPatterns = {"/AssociateIssueMealServlet"})
public class AssociateIssueMealServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
          ...
          DBConnect.connectDB();
              ...
              ArrayList<Benefaction> benefaction = DBConnect.getBenefactionRecordsMealcard(FIN_Num);
              ...
              String ProbKey = (String)request.getSession().getAttribute("ProbKey");
               ...
               DBConnect.InsertMealRecord(RegisterDate,JobKey, ProbKey, Benefit, SerialNum, FIN_Num);
