    ...
    <head>
        ...
        <script>
            ...
            function onSubmit() {
                ...
                form1.submit(); //pass to view page
            }
            ...
            <table border ="2" align="center" style="width:100%">
                ...
                <tr>
                    ...
                    <td rowspan="4" class="container6" valign="top"> <%--container6 --%>
                       <form name="form1" method="Get" action="AttachmentDownloadServlet">
                            <% ArrayList<String> documentNames = DBConnect.retrieveDocuments(FIN);
                                
                                for(int i = 0; i < documentNames.size(); i++) { 
                                      int j = 1;%>
                                <div style="margin-left:20px"><input type="radio" name="<%=j%>" value="<%=documentNames.get(i)%>">&nbsp&nbsp<%=documentNames.get(i)%><br/>
                                    <%j++;%>
                                </div>   
                            <%}%>
                ...
                <tr>
                    ...
                    <td colspan="2" class="container9">
                        <button type="submit" class="btn btn-primary btn-large" onClick="onSubmit();"><span style="font-size:13px;">Download Attachment</span></button>
                        <a type="button" class="btn btn-primary btn-large" href="/TWC2-CaseManagementSystem/UploadAttachment.jsp"><span style="font-size:13px;">Upload</span><br/> <span>Attachment</span></a>
