<%-- 
    Document   : OverviewTCRP
    Created on : Jun 14, 2014, 12:41:17 AM
       ...
       <!--stylesheet-->
        ...
        <!--javascript-->
           <script>
            ...
            function onSubmit(){
                document.form1.action="/TWC2-CaseManagementSystem/AssociateOverviewTCRPServlet";
            }
             function onLogout(){
        ...
        <table border ="2" class ="leftDivision">
            ...
            <tr>
                <td class="containerD" style="height:10%">
                    <div class="headertitle-associate">
                        TCRP OVERVIEW  
                    </div>
