<%-- 
    Document   : AssociateViewFareGo
    Created on : Aug 1, 2014, 3:56:50 PM
    ...
    <head>
        ...
        <script src="/TWC2-CaseManagementSystem/jquery/jquery-validate-1.12.0.js"></script>
          ...
          <script>
             ...
             function onSubmit(){
                  document.location.href="/TWC2-CaseManagementSystem/AssociateEditFareGo.jsp";
             }
                    ...
                    <div class="maincontent-associate">
                        ...
                        <%
                                ...
                                DBConnect.connectDB();
                                        ...
                                        Benefaction bene3 =DBConnect.getBenefactionRecordsFareGo2(id1);
                                        ...
                                        String value = bene3.getBeneValue();
                                        String remarks=bene3.getBeneRem();
                        ...
                        <div class="form-group-associate">
                            Date benefit given
                            <div class="form-control-associate"><%=bene3.getBeneDate()%></div>
                        </div>
                        <div class="form-group-associate">
                            Name of worker
                        ...
                        <div class="form-group-associate">
                            Type of benefit
                            <div class="form-control-associate"><%=beneType%></div>
                        </div>
                        <div class="form-group-associate">
                            Serial number
                            <div class="form-control-associate"><%=serialNumber%></div>
                        </div>
                           <div class="form-group-associate">
                            Usable value
                            <div class="form-control-associate"><%=value%></div>
                        </div>
                           <div class="form-group-associate">
                            Remarks, conditions or time frame attached to benefit
                            <div class="form-control-associate" style="height: 80px;"><%=remarks%></div>
                        </div>
