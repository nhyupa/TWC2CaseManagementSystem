...
public class DBConnectTest {
    public static void main (String[] args){
        ...
        String passportExpiryDate = "2018-03-05";
            ...
            //Worker worker = new Worker("G0909491N","2014-01-01","Sam","Yupa","testWorker","M", "Myanmar","","1992-01-15");
           // DBConnect.insertPassDetails("Work Permit", "12345", "2014-09-05", "2016-09-05", "G0909493N", "Construction");
//            ArrayList<String> employers = DBConnect.getEmployers("G0909492N");
//            System.out.println(employers.size());
            //DBConnect.createWorker(worker);
//            ArrayList<ChiefProblem> problems = DBConnect.retrieveProbKeys("G0909492N");
//            System.out.println("Size : "  + problems.size());
//            
//            for(int i = 0 ; i < problems.size() ; i++) {
//                ChiefProblem problem = problems.get(i);
//                
//                System.out.println(problem.getChiefProblem());
//            }
//        }catch(Exception err){
//            err.printStackTrace();
//        }
            
//            DBConnect.InsertWorkerPhoneDetails("G0909492N", "90439566", "2014-08-08");
